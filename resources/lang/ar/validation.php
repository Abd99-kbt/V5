...
return [
    ...
    */
    ...
    'extensions' => 'يجب أن يكون لملف :attribute إحدى الامتدادات التالية: :values.',
    ...
    'in_array_keys' => 'يجب أن يحتوي حقل :attribute على واحدة على الأقل من المفاتيح التالية: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة في حقل :attribute ظهرت في تسرب بيانات. يرجى اختيار قيمة مختلفة.',
    ],
    ...
    'unique' => 'قيمة :attribute مأخوذة مسبقاً.',
    ...
    */
    ...
    'custom' => [
        'login' => [
            'invalid_format' => 'يجب أن يكون حقل تسجيل الدخول عنوان بريد إلكتروني صحيح أو اسم مستخدم.',
            'username_format' => 'يجب أن يكون اسم المستخدم بين 3-20 حرفاً ويحتوي على أحرف وأرقام وشرطات سفلية وشرطات فقط.',
